...
class WarmHorariosCache extends Command
{
    ...
    public function handle(TransporteService $transporteService): int
    {
        ...
        // Resgata as viações ativas no banco local usando o seu model correto
        $viacoes = Viacao::where('ativo', true)->get();
        ...
        foreach ($viacoes as $viacao) {
            // Pula explicitamente viações que não possuam api_id sincronizadoo
            ...
            // Inicializa a barra de progresso para as linhas desta viação
